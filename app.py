...
import pickle
import telepot
rakesh = telepot.Bot('7039203788:AAEhTB4NXaDKq2n6AoYK5Zxh0IkueYWgtog')
...
def predict():
    if request.method == 'POST':
        ...
        rakesh.sendMessage('1828222763', str(num))
    ...
    if request.method == 'POST':
        ...
        if OTP == OTP1:
            ...
            if count1 > count2:
                ...
                rakesh.sendPhoto('1828222763',photo=open("out.jpg","rb"))
